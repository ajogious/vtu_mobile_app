...
class ApiConfig {
  static String get liveBaseUrl => FlavorConfig.instance.baseUrl;
  ...
  static const String atcNetworksEndpoint = '/plans/a2c.php';

  // Paystack
  static const String paystackInitEndpoint = '/paystack/init.php';
  static const String paystackCallbackEndpoint =
      '/paystack/paystack_callback.php';
